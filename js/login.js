...
//         document.getElementById("registrarseBt").addEventListener('click', registerLogin);
//         document.getElementById("iniciarSesionBt").addEventListener('click',inicioDeSesion );
...
//             const emailSt = document.getElementById("emailSt").value;
//             const passwordSt = document.getElementById("passwordSt").value;
            
//             if (localStorage.getItem("singUp")) {
//                 login = JSON.parse(localStorage.getItem("singUp"));
//             }
//         }
...
let baseDeDatosLogin = JSON.parse(localStorage.getItem("sistema-de-login"));
